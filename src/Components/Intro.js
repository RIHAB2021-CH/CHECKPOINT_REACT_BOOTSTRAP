...
const Intro = () => {
  ...
  return (
    <div classname="container-intro">  
      ...
      <h1 className="title-about">We are your confident partener</h1>
      <div className="description">
        <p>
        Web Design is a tunisian registered web design company based in Tunis,Tunisia. Established in 2021 our company provides web design and development services to customers in Tunisia .
        </p>
        <p>
